...
public record TeleportDestination(Type type,String name,int x,int y,int z,String command,
    ...
    public enum Reason{OWN_TOWN,OWN_NATION,ALLIED_NATION,OUTSIDER_SPAWN_ENABLED,SAME_NATION_ACCESS,ADVANCED_JOIN_ACCESS,ENEMY_NATION,OUTSIDER_SPAWN_DISABLED,PUBLIC_SPAWN_DISABLED,NOT_MEMBER_OR_ALLY,UPKEEP_UNCERTAIN,API_DATA_MISSING,NOT_MEMBER,UNKNOWN_DATA}
