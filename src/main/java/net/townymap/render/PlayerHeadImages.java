        ...
        CompletableFuture.runAsync(() -> {
            ...
            Runnable apply = () -> {
                ...
                try {
                    ...
                    Identifier id = Identifier.of("townymapaddon", "head/" + key.replaceAll("[^a-z0-9_]", "_"));
                    mc.getTextureManager().registerTexture(id, new NativeImageBackedTexture(() -> "head " + key, img));
                    ...
                    if (evicted != null) mc.getTextureManager().destroyTexture(evicted);
