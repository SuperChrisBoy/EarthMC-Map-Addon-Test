...
public final class UiScale {
    ...
    public static void push(GuiGraphicsExtractor ctx, float cx, float cy) {
        push(ctx, get(), cx, cy);
    }

    public static void push(GuiGraphicsExtractor ctx, float s, float cx, float cy) {
    ...
    public static MouseButtonEvent unscaleClick(MouseButtonEvent click, double cx, double cy) {
        return new MouseButtonEvent(unscale(click.x(), cx), unscale(click.y(), cy), click.buttonInfo());
    }
}
