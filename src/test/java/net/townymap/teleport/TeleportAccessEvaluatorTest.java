...
class TeleportAccessEvaluatorTest {
    ...
    private static net.townymap.model.TownData mapTown(String name,int center){return new net.townymap.model.TownData(name,0,Collections.singletonList(new int[][]{{center,0},{center+1,0},{center+1,1}}));}
