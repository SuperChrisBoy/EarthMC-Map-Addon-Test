...
class TeleportAccessEvaluatorTest {
    ...
    @Test void partialBulkSnapshotIsRejected(){assertFalse(TeleportSnapshotValidation.usable(true,40,100,100));assertFalse(TeleportSnapshotValidation.usable(false,100,100,100));assertTrue(TeleportSnapshotValidation.usable(true,80,1,100));}
